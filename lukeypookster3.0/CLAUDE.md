...
- **DONE (2026-07-04): Loading screen** (`components/loading/LoadingScreen.tsx`, mounted in `App.tsx`):
  ...
  (this fixed Luke's "button doesn't match" note). **The planned ascii cursor effect is just
